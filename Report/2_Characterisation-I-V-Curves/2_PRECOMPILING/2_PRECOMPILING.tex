...
In the following we will present the results acquired when performing the analysis described in the previous section for each of the sets $\mathbb{S}_1$, $\mathbb{S}_3$, $\mathbb{S}_5$ and $\mathbb{S}_\star$.
...
\subsection{Set with PEIE electron injection layer}
